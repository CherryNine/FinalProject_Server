...
let SecurityService = class SecurityService {
    ...
    async getAccessToken(user) {
        const accessToken = await this.jwtService.signAsync({ email: user.email, sub: user.id, role: user.role }, {
    ...
    async getAndSaveRefreshToken(user) {
        const refreshToken = await this.jwtService.signAsync({ email: user.email, sub: user.id, role: user.role }, {
